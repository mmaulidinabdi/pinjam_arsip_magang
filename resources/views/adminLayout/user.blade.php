                ...
                <div id="updateProductModal{{ $peminjam->id }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <!-- Modal body -->
                            <form id="updateForm{{ $peminjam->id }}" action="/admin/updateUser/{{ $peminjam->id }}"
                                method="POST" onsubmit="return validateForm({{ $peminjam->id }})">
                                @csrf
                                @method('PUT')
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="email" id="email{{ $peminjam->id }}"
                                            value="{{ $peminjam->email }}" disabled
                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    ...
                                    <div class="mb-6">
                                        <label for="confirm_password"
                                            ...
                                            Password</label>
                                        <div class="relative">
                                            <input type="password" id="confirm_password{{ $peminjam->id }}"
                                ...
                                <div class="text-red-500 text-sm mb-4 hidden" id="error_message{{ $peminjam->id }}">
                                    Password dan Confirm Password Tidak Cocok!</div>
