    ...
    <tbody>
        @foreach ($histories as $history)
            <tr>
                ...
                <td>
                    @if ($history->status === 'diacc' && is_null($history->tanggal_pengembalian))
                        <p>Arsip belum dikembalikan</p>
                    @elseif ($history->status === 'diacc' && !is_null($history->tanggal_pengembalian))
                        <p>{{ $history->tanggal_pengembalian }}</p>
                    @endif
