...
<form action="/user/{{ Auth::user()->id }}/updateProfile" method="POST" enctype="multipart/form-data">
    ...
    <div id="alert" class="top-0 w-full  mt-4 p-4 mb-4 text-sm text-white rounded-lg bg-green-500 dark:bg-gray-800 dark:text-red-400" role="alert">
    ...
    @csrf
    <p
        class=" inset-x-0 top-0 p-4 mb-4 text-sm text-white rounded-lg bg-red-600 dark:bg-gray-800 dark:text-red-400 {{ Auth::user()->is_verified ? 'text-white bg bg-green-700' : 'text-red-500' }}">
