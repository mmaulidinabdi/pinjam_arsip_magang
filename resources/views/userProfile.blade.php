...
<form>
    <p class=" inset-x-0 top-0 p-4 mb-4 text-sm text-white rounded-lg bg-red-600 dark:bg-gray-800 dark:text-red-400 {{ Auth::user()->is_verified ? 'text-green-500' : 'text-red-500' }}">
        ...
        <div>
            ...
            <div>
                ...
                <input type="tel" id="phone"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    value="{{ Auth::user()->no_telp }}" placeholder="" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required />
            </div>
...
<script>
    function previewFile(event) {
        ...
        if (file && file.type.startsWith('image/')) {
            ...
            previewContainer.classList.add('hidden'); // Hide preview if not an image
